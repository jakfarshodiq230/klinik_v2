...
$edit = mysqli_query($koneksi,"select * from obat where kd_obat='".$_GET["nmr"]."'");
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["obt"]){
			include_once("../library/koneksi.php");
			mysqli_query($koneksi, "update obat set nm_obat='".$_POST["nama"]."', jml_obat='".$_POST["jml"]."', ukuran='".$_POST["ukr"]."', harga='".$_POST["hrg"]."' where kd_obat='".$_GET["nmr"]."'");
		...
		<div class="body">
			<form action="" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input type="number" value="<?php echo $editDb["jml_obat"];?>" required name="jml" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">Ukuran</label>
							<div class="col-lg-4">
								<input type="number" value="<?php echo $editDb["ukuran"];?>" required name="ukr" class="form-control" />
							</div>
						</div>
						<div class="form-group">
