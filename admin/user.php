...
$max	 = ceil($jml/$row);
?>
<a href="#myModal" class="btn btn-primary btn-rect" data-toggle="modal"><i class='icon icon-white icon-plus'></i> Tambah User</a>
<a href="user_cetak.php" class="btn btn-warning btn-rect"><i class='icon icon-white icon-print'></i> Cetak</a><p>
<?php
	if($_POST["user"]){
			include_once("../library/koneksi.php");

			mysqli_query($koneksi, "insert into login set username='".$_POST["usr"]."', password='".md5($_POST["pas"])."', nama='".$_POST["nama"]."', alamat='".$_POST["alt"]."'");

			echo "<meta http-equiv='refresh' content='2; url=?menu=user'>";
	...
	<div class="panel-body">
		<div class="table-responsive">
			...
			<?php
				...
				$usQry = mysqli_query($koneksi, $usSql)  or die ("Query Obat salah : ".mysql_error());
				$nomor  = 0; 
