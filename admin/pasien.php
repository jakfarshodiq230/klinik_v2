...
$max	 = ceil($jml/$row);
?>
<a href="?menu=tambah_pasien" class="btn btn-primary btn-rect"><i class='icon icon-white icon-plus'></i> Tambah Pasien</a>
<a href="pasien_cetak.php" class="btn btn-warning btn-rect"><i class='icon icon-white icon-print'></i> Cetak</a><p>
	...
	<div class="panel-body">
		<div class="table-responsive">
			...
			<?php
				...
				$pasienQry = mysqli_query($koneksi , $pasienSql)  or die ("Query pasien salah : ".mysql_error());
				$nomor  = 0; 
