...
$max	 = ceil($jml/$row);
?>
<a href="?menu=rekam_add" class="btn btn-primary btn-rect"><i class='icon icon-white icon-plus'></i> Tambah Rekam Medis</a>
<a href="rekam_cetak.php" class="btn btn-warning btn-rect"><i class='icon icon-white icon-print'></i> Cetak</a>
<p>
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				<thead>
					...
					<?php
						$rmSql = "SELECT * FROM rekam_medis, pasien where rekam_medis.no_pasien=pasien.no_pasien ORDER BY no_rm DESC LIMIT $hal, $row";
						$rmQry = mysqli_query($koneksi, $rmSql)  or die ("Query Rekam Medis salah : ".mysql_error());
						$nomor  = 0; 
