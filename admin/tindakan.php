...
$max	 = ceil($jml/$row);
?>
<a href="#myModal" class="btn btn-primary btn-rect" data-toggle="modal"><i class='icon icon-white icon-plus'></i> Tambah Tindakan</a>
<a href="tindakan_cetak.php" class="btn btn-warning btn-rect"><i class='icon icon-white icon-print'></i>Cetak</a><p>
<?php
	if($_POST["tdk"]){
			include_once("../library/koneksi.php");
			mysqli_query($koneksi, "insert into tindakan set nm_tindakan='".$_POST["nama"]."', ket='".$_POST["ket"]."'");
			echo "<meta http-equiv='refresh' content='2; url=?menu=tindakan'>";
	...
	<div class="panel-body">
		<div class="table-responsive">
			...
			<?php
				...
				$tndQry = mysqli_query($koneksi, $tndSql)  or die ("Query tindakan salah : ".mysql_error());
				$nomor  = 0; 
