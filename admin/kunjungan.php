...
$max	 = ceil($jml/$row);
?>
<a href="?menu=kunjungan_add" class="btn btn-primary btn-rect" data-toggle="modal"><i class='icon icon-white icon-plus'></i> Tambah Kunjungan</a>
<a href="kunjungan_cetak.php" class="btn btn-warning btn-rect"><i class='icon icon-white icon-print'></i> Cetak</a><p>
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="table-responsive">
			...
			<?php
				$kjgSql = "SELECT * FROM kunjungan, petugas WHERE kunjungan.kd_petugas=petugas.kd_petugas ORDER BY kd_kunjungan DESC LIMIT $hal, $row";
				$kjgQry = mysqli_query($koneksi, $kjgSql)  or die ("Query Kunjungan salah : ".mysql_error());
				$nomor  = 0; 
