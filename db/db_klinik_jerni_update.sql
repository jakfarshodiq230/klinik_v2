...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Mar 2021 pada 05.28
...
CREATE TABLE `rekam_medis` (
  ...
  `ket` text NOT NULL,
  `total_beaya` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Struktur dari tabel `sm_therapy`
--

CREATE TABLE `sm_therapy` (
  `id_therapy` int(50) NOT NULL,
  `no_rm` varchar(50) NOT NULL,
...
--
-- Indeks untuk tabel `sm_therapy`
--
ALTER TABLE `sm_therapy`
...
--
-- AUTO_INCREMENT untuk tabel `sm_therapy`
--
ALTER TABLE `sm_therapy`
  MODIFY `id_therapy` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `therapy`
--
ALTER TABLE `therapy`
  MODIFY `kode_therapy` int(50) NOT NULL AUTO_INCREMENT;
